...
fn forwards_alu_result_with_one_instruction_gap() {
    ...
    let prog: [inst; 3] = [
        // v4 = 10 + 3 = 13
        inst::ADD128 { rd: 4, rs1: 1, rs2: 2 },

        // independent instruction
        inst::ADD128 { rd: 5, rs1: 1, rs2: 3 },

        // should use forwarded v4 = 13
        // v6 = 13 + 7 = 20
        inst::ADD128 { rd: 6, rs1: 4, rs2: 3 },
    ];
...
fn jump_flushes_wrong_path_instruction() {
    ...
    let prog: [inst; 4] = [
        ...
        inst::ADD128 { rd: 5, rs1: 1, rs2: 2 },

        // Real target.
        inst::ADD128 { rd: 4, rs1: 2, rs2: 3 },
    ];
